...
function displayProducts() {
  ...
  let filteredData = allproducts.products.filter((myProducts) =>
    myProducts.title.toLowerCase().includes(searchTerm)
  );

  cards.innerHTML = filteredData
    .map(
      (myProducts) => `
          <div class="productCards">
                <img src=${myProducts.images[0]} alt="product" />
                <div class="productHeader">
                  <h3 class="category">${myProducts.category}</h3>
                  <h4 class="price">$${myProducts.price}</h4>
                </div>
                <h2 class="title">${myProducts.title}</h2>
